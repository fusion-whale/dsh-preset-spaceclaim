...
const DESCRIPTION =
	...
	"(`box`, `cylinder`, `tube`, `sphere`, `cone_frustum`, `elbow`, `torus`, `profile_prisms`, `move`, `rotate`, `split_face_by_line`, " +
	"`round_edges`, `chamfer_edges`, `name_boundaries`, `name_faces_by_rules`, `finish`); the runner injects those helpers, " +
